...
START_OP = [
    [
        Button.url("🍁 ᴀᴋᴀsʜ", "https://t.me/Akash_Daksh1c"),
        Button.url("ᴍᴜsɪᴄ ʙᴏᴛ 🕸️", "https://t.me/AD_Creation_Chatzone")
    ],
    [
...
async def start(event):
    if event.is_private:
        ...
        bot_id = KEX.id
        TEXT = f"**╭────── ˹ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ˼ ⏤͟͟͞͞‌‌‌‌★**\n**┆**\n**┊◍ ʜᴇʏ : [{event.sender.first_name}] **\n**┆◍ ɪ ᴀᴍ : [{bot_name}](tg://user?id={bot_id}) **\n**┊**\n**┆● sᴀɴᴀᴛᴀɴɪ ʙᴏᴛ ᴠᴇʀsɪᴏɴ :** `0.2`\n**┊● ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ :** `8.2.5.1.01`\n**╰─────────────────────────**\n**──────────────────────────**\n**⦿ Oᴡɴᴇʀ - [🩵᪲᪲᪲𓍯 𝐀𝐊𝐀𝐒𝐇𓂃𓏧♡ 🌸](https://t.me/WTF_NoHope) | [🩵᪲᪲᪲𓍯 𝐀𝐊𝐀𝐒𝐇𓂃𓏧♡ 🌸](https://t.me/Akash_Daksh1c) **\n**──────────────────────────**\n**    ❖ Uᴘᴅᴀᴛᴇ's ⏤͟͟͞͞‌‌‌‌ [❖ ∣ Sᴀɴᴀᴛᴀɴɪ Nᴇᴛᴡᴏʀᴋ ∣ ❖](https://t.me/Sanatani_Network) **\n**──────────────────────────**"
